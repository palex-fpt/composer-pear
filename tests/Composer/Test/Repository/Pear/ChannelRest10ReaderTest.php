...
class ChannelRest10ReaderTest extends \PHPUnit_Framework_TestCase
{
    public function testShouldBuildPackagesFromPearSchema()
    {
        $rfs = new RemoteFilesystemMock(array(
            ...
            'http://test.loc/rest10/r/http_request/deps.1.4.0.txt' => file_get_contents(__DIR__ . '/Fixtures/Rest1.0/http_client_requiest.1.4.0.txt'),
        ));
        ...
        $this->assertEquals('HTTP_Client', $packages[0]['package']);
        $this->assertEquals('HTTP_Request', $packages[1]['package']);
    }
}
